  ...
  class customersProcess {
    ...
    private function create() {
      try {
        ...
        //   $mail -> CharSet="UTF-8";
        //   $mail -> Username = 'dondiegorada@gmail.com';   // Nombre de usuario SMTP
        //   $mail -> Password = 'Batman3039497444';   // Contraseña SMTP
        ...
        //   $mail -> addAddress('bryansugi@gmail.com', 'lucistudio');   // Establecer a donde se enviará el mensaje
        ...
        //   $mail -> Subject = 'Solicitud modelo webcam lucistudio';   //Asunto del mensaje
        ...
        //                 <h1 style'color: #ffffff !important'>Solicitud modelo webcam LuciStudio</h1>
