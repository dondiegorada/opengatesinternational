    ...
    <main>
      ...
      <section class="container-fluid container-nosotros mt-6">
        ...
        <div class="row mt-5">
          <div class="col-9">
            <div class="card">
              <h5 class="card-header">¿La tarjeta de residencia permanente tiene un período de validez?</h5>
              ...
              <div class="card-body">
                ...
                <p class="card-text"><small class="text-muted">March 10, 2001, 5:16 pm</small></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-sm-12 mb-4">
                <div class="card">
                  <h5 class="card-header">Tarjeta de residencia temporal: ¿cómo conseguirla?</h5>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <h5 class="card-header">Tarjeta de residencia permanente y tarjeta de residencia temporal: ¿de qué se trata exactamente?</h5>
